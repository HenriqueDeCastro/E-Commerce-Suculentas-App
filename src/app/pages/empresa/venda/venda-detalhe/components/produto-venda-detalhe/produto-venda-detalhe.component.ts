...
@Component({
  selector: 'app-produto-venda-detalhe',
  templateUrl: './produto-venda-detalhe.component.html',
  styleUrls: ['./produto-venda-detalhe.component.scss']
})
export class ProdutoVendaDetalheComponent implements OnInit {
